...
char const *const RED_TIMEOUT_FILE   = "/sys/class/leds/red/delay_on";
char const *const GREEN_TIMEOUT_FILE = "/sys/class/leds/green/delay_on";
char const *const BLUE_TIMEOUT_FILE  = "/sys/class/leds/blue/delay_on";
